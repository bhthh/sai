...
ZelzalPRO_cmd = (
    "𓆩 [  𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗔𝗚𝗔𝗥𝗔 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الاذا؏ـــة](t.me/Tepthon) 𓆪\n\n"
    ...
    "\n 𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗔𝗚𝗔𝗥𝗔](t.me/uwrwe) 𓆪"
)


# Copyright (C) 2022 Magara-Thon . All Rights Reserved
...
async def gcast(event):
    ...
    if zedthon: #Write Code By T.me/KBK8K
    ...
    async for x in event.client.iter_dialogs():
        if x.is_group:
            chat = x.id
            try:
                if zelzal.text: #Write Code By T.me/kbk8k
                    try:
